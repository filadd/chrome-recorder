  ...
  return (
    <div className="overlay settings-overlay">
      <header className="header">
        <h2 className="header-name">{t("settings_title")}</h2>
        <button className="gear" title={t("settings_back")} onClick={onClose}>
          ←
        </button>
      </header>
      ...
      <div className="settings-body">
        <div className="field">
          ...
          <input
            ...
            onChange={(event) => onUpdate({ userId: event.target.value.trim() })}
          />
        </div>
        ...
        {settings.enabledProfileIds.includes("project") ? (
          <div className="field">
